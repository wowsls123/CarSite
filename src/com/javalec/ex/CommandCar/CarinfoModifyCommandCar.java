...
public class CarinfoModifyCommandCar implements CommandCar {
	...
	public void execute(HttpServletRequest request, HttpServletResponse response) {
	    ...
	    dao.Carinfo_modify(member_car, car_kM, car_Num, car_ProductY, car_color, car_brand, car_type, car_Accident, member_id);
	}
