...
<table style="justify-content: center;">
		...
		<tr>
			<td class="td1">번호</td>
			<td class="td1">${BuyReview_view.bRNum }</td>
		</tr>
		<tr>
			<td class="td1">조회수</td>
			<td class="td1">${BuyReview_view.bRHit } </td>
		</tr>
		<tr>
			<td class="td1">글쓴이</td>
			<td class="td1">${BuyReview_view.bRId}</td>
		</tr>
		<tr>
			<td class="td1">제목</td>
			<td class="td1">${BuyReview_view.bRTitle}</td>
		</tr>
		<tr>
			<td class="td1">차종</td>
			<td class="td1">${BuyReview_view.bRCar} </td>
		</tr>
		<tr>
			<td id="content">내용</td>
  ...
  width: 500px	 ">
		<tr>
	   <td><textarea name="Car" id="Car" required style="height: 100px; width: 100%" disabled>${BuyReview_view.bRContent}</textarea></td>
		</tr>
		</table>
		<table  style=" justify-content: center;">
		<tr>
